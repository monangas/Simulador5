    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown">
                    <a class="dropdown-toggle" data-toggle="dropdown" href="../administrador/a.php">Gestión Recetario<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li><a href="../administrador/a.php">Crear recetas</a></li>
                        <li><a href="../administrador/a.php">Consultar recetas</a></li>
                        <li><a href="../administrador/a.php">Actualizar recetas</a></li>
                        <li><a href="../administrador/a.php">Eliminar recetas</a></li>
